...
//
			...
			SmartDashboard.putData("Defense 3", new PrepareVisionCommand(3, true));
			SmartDashboard.putData("Defense 4", new PrepareVisionCommand(4, true));
			SmartDashboard.putData("Defense 5", new PrepareVisionCommand(5, true));
